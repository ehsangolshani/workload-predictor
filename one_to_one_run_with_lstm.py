...
workload_dataset = SimpleWorkloadDataset(
...
model: LSTMModel = LSTMModel(input_size=input_size,
...
torch.save(model.state_dict(), "trained_models/one_to_one_LSTM_workload_model_nasa_dataset.pt")
